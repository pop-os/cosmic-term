...
pub fn key_binds() -> HashMap<KeyBind, Action> {
    ...
    bind!([Alt], Key::Character("1".into()), TabActivate0);
    bind!([Alt], Key::Character("2".into()), TabActivate1);
    bind!([Alt], Key::Character("3".into()), TabActivate2);
    bind!([Alt], Key::Character("4".into()), TabActivate3);
    bind!([Alt], Key::Character("5".into()), TabActivate4);
    bind!([Alt], Key::Character("6".into()), TabActivate5);
    bind!([Alt], Key::Character("7".into()), TabActivate6);
    bind!([Alt], Key::Character("8".into()), TabActivate7);
    bind!([Alt], Key::Character("9".into()), TabActivate8);
